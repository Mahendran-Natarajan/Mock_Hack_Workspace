...
import com.scrotify.service.impl.TransactionServiceImpl;
...
public class FundTransferServiceTest {
    ...
    public void testFundTransfer() {
        ...
        Mockito.when(accountRepository.findByCustomerByAccount(anyLong(), anyString(), anyString())).thenReturn(account);
